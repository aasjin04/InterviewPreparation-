...
export default function Signup() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      alert("Account created successfully. Welcome to Nourique!");
      navigate("/");
    } catch (error) {
      alert(
          ...
          <div className="relative z-10 flex h-full w-full max-w-2xl flex-col justify-center animate-[fadeUp_0.7s_ease-out_both]">
            ...
            <div className="mt-10">
              <p className="mb-4 inline-flex rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm font-semibold text-blue-100 shadow-sm backdrop-blur-xl">
                Start your AI career preparation workspace
              </p>

              <h1 className="max-w-xl text-5xl font-semibold tracking-tight text-white xl:text-6xl">
                Create your Nourique account
              </h1>

              <p className="mt-4 max-w-lg text-base leading-7 text-slate-300">
                Set up your profile, upload your first resume, and start
                improving it with ATS checks, skill-gap insights, and mock
            ...
            <div className="relative mt-7 h-[330px]">
              <PreviewCard className="left-0 top-0 w-[340px] animate-[floatSoft_6s_ease-in-out_infinite]">
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                  <MiniStat label="ATS" value="0" tone="emerald" />
                  <MiniStat label="Skills" value="0" tone="blue" />
                  <MiniStat label="Mock" value="0" tone="violet" />
                </div>

                <div className="mt-3 space-y-3">
                  {[
                    "Upload one active resume",
                    "Unlock analyzer and ATS checker",
                  ].map((item) => (
              ...
              <PreviewCard className="bottom-0 right-0 w-[320px] animate-[floatSoft_5s_ease-in-out_infinite] [animation-delay:0.8s]">
                ...
                <div className="mt-4 rounded-2xl bg-white/[0.055] p-4 ring-1 ring-white/10">
                  <p className="text-sm leading-6 text-slate-300">
                    Nourique turns your resume into a preparation dashboard for
                    builder tools, skill tracking, aptitude practice, and
                    interviews.
                  </p>
                </div>

                <div className="mt-4 grid grid-cols-2 gap-2">
                  {["Resume builder", "ATS checker", "Skill tracker", "Mock interview"].map(
                    (item) => (
                      <div
                        key={item}
            ...
            >
              <div className="mb-5 text-center">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  Start building ATS-ready resumes and personalized interview
                  preparation tools with Nourique.
                </p>
              </div>
